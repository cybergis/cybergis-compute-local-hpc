        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, this.redis.push([this.name, item.id])];
                    case 2:
                        _a.sent();
                        return [2];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        jobId = _a.sent();
                        return [2, this.getJobById(jobId)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4, jobRepo.findOne(id)];
                    case 2:
                        job = _b.sent();
                        if (!job)
                            return [2, null];
                        if (!job.credentialId) return [3, 4];
                        _a = job;
                        return [4, this.credentialManager.get(job.credentialId)];
                    case 3:
