...
var SlurmConnector = (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.upload(this.maintainer.executableFolder, this.remote_executable_folder_path, true)];
                    case 1:
                        _a.sent();
                        return [4, this.mkdir(path.join(this.remote_result_folder_path, 'slurm_log'))];
                    case 2:
                        _a.sent();
                        return [4, this.createFile(this.template, path.join(this.remote_executable_folder_path, 'job.sbatch'), {}, true)];
                    case 3:
                        _a.sent();
                        jobJSON = {
                        ...
                        return [4, this.createFile(jobJSON, path.join(this.remote_executable_folder_path, 'job.json'))];
                    case 4:
                        _a.sent();
                        if (!this.maintainer.dataFolder) return [3, 13];
                        if (!(this.maintainer.dataFolder instanceof FileSystem_1.LocalFolder)) return [3, 6];
                        return [4, this.upload(this.maintainer.dataFolder, this.remote_data_folder_path, true)];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6:
                        if (!(this.maintainer.dataFolder instanceof FileSystem_1.GlobusFolder)) return [3, 12];
                    ...
                    case 7:
                        ...
                        return [4, GlobusUtil_1.default.initTransfer(this.maintainer.dataFolder, to, this.config, this.jobID)];
                    case 8:
                        taskId = _a.sent();
                        if (this.maintainer != null)
                        ...
                        monitorTransfer = function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 4]);
                                        return [4, GlobusUtil_1.default.monitorTransfer(taskId, this.config)];
                                    case 1:
                                        status = _a.sent();
                                        return [2, status];
                                    case 2:
                                        e_2 = _a.sent();
                                        return [4, monitorTransfer()];
                    ...
                    case 11:
                        ...
                        _a.label = 12;
                    case 12: return [3, 15];
                    case 13: return [4, this.mkdir(this.remote_data_folder_path, {}, true)];
                    case 14:
                        _a.sent();
                        _a.label = 15;
                    case 15:
                        ...
                        return [4, this.mkdir(this.remote_result_folder_path, {}, true)];
                    case 16:
                        _a.sent();
                        if (this.maintainer != null)
                            this.maintainer.emitEvent('SLURM_SUBMIT', "submitting slurm job");
                        return [4, this.exec("sbatch job.sbatch", {
                    ...
                    case 17:
                        ...
                        return [4, this.maintainer.updateJob({ slurmId: this.slurm_id })];
                    case 18:
                        _a.sent();
                        if (this.maintainer != null)
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4, this.exec("squeue --job ".concat(this.slurm_id), {}, true, true)];
                    case 1:
                        squeueResult = _a.sent();
                        if (!squeueResult.stderr && squeueResult.stdout) {
                            r = squeueResult.stdout.split(/[ |\n]+/);
                            i = r.indexOf(this.slurm_id);
                            return [2, i >= 0 ? r[i + 4] : 'UNKNOWN'];
                        }
                        return [4, this.exec("qstat ".concat(this.slurm_id), {}, true, true)];
                    case 2:
                        qstatResult = _a.sent();
    ...
    SlurmConnector.prototype.cancel = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.exec("scancel ".concat(this.slurm_id), {}, true)];
                    case 1:
                        _a.sent();
                        return [2];
                }
    ...
    SlurmConnector.prototype.pause = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.exec("scontrol suspend ".concat(this.slurm_id), {}, true)];
                    case 1:
                        _a.sent();
                        return [2];
                }
    ...
    SlurmConnector.prototype.resume = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.exec("scontrol resume ".concat(this.slurm_id), {}, true)];
                    case 1:
                        _a.sent();
                        return [2];
                }
    ...
    SlurmConnector.prototype.getSlurmStdout = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.cat(path.join(this.remote_result_folder_path, 'slurm_log', 'job.stdout'), {})];
                    case 1:
                        out = _a.sent();
    ...
    SlurmConnector.prototype.getSlurmStderr = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.cat(path.join(this.remote_result_folder_path, 'slurm_log', 'job.stderr'), {})];
                    case 1:
                        out = _a.sent();
                        if (this.maintainer && out)
                            this.maintainer.emitLog(out);
    ...
    SlurmConnector.prototype.getRemoteResultFolderContent = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.exec("find . -type d -print", { cwd: this.getRemoteResultFolderPath() }, true, true)];
                    case 1:
                        findResult = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4, this.exec("seff ".concat(this.slurm_id), {}, true, true)];
                    case 2:
                        seffResult = _b.sent();
