...
var GlobusTaskListManager = (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, this.redis.setValue("globus_task_".concat(label), taskId)];
                    case 2:
                        _a.sent();
                        return [2];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, this.redis.getValue("globus_task_".concat(label))];
                    case 2:
                        out = _a.sent();
                        return [2, out ? out : null];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(config_1.config.redis.password != null && config_1.config.redis.password != undefined)) return [3, 2];
                        redisAuth = promisify(client.auth).bind(client);
                        return [4, redisAuth(config_1.config.redis.password)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
...
var GlobusUtil = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4, globusTransferRefreshTokenRepo.findOne(hpcConfig.globus.identity)];
                    case 2:
                        g = _a.sent();
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4, PythonUtil_1.default.run('globus_init.py', [
    ...
    GlobusUtil.monitorTransfer = function (taskId, hpcConfig) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this._queryStatus(taskId, hpcConfig, 'globus_monitor.py')];
    ...
    GlobusUtil.queryTransferStatus = function (taskId, hpcConfig) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this._queryStatus(taskId, hpcConfig, 'globus_query_status.py')];
                    case 1: return [2, _a.sent()];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4, PythonUtil_1.default.run(script, [
                                config_1.config.globus_client_id,
                                g.transferRefreshToken,
                                taskId
                            ], ['status'])];
