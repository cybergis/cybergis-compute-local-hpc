        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, this.redis.setValue(key, JSON.stringify(cred))];
                    case 2:
                        _a.sent();
                        return [2];
                }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.sent();
                        _b = (_a = JSON).parse;
                        return [4, this.redis.getValue(key)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2: return [4, jobRepo.findOne({ secretToken: secretToken })];
                    case 3:
                        if (!_a.sent()) return [3, 4];
                        secretToken = Helper_1.default.randomStr(45);
                        return [3, 2];
                    case 4: return [2, secretToken];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4, jobRepo.findOne(rawAccessToken.id, options)];
                    case 2:
                        job = _a.sent();
                        if (!job)
                            throw new Error('invalid accessToken provided');
