...
var GlobusFolder = /** @class */ (function (_super) {
...
var LocalFolder = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fs.promises.access(this.path, fs.constants.F_OK)];
                    case 1:
                        _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fs.promises.chmod(path.join(this.path, filePath), mode)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.putFileFromString(template, filePath)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!!fs.existsSync(fileParentPath)) return [3 /*break*/, 3];
                        return [4 /*yield*/, fs.promises.mkdir(fileParentPath, { recursive: true })];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4 /*yield*/, fs.promises.writeFile(filePath, content, {
                            mode: 493
                        })];
                    case 4:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!!fs.existsSync(folderPath)) return [3 /*break*/, 3];
                        return [4 /*yield*/, fs.promises.mkdir(folderPath, { recursive: true })];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [2 /*return*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fs.promises.access(this.path + '.zip', fs.constants.F_OK)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, true];
                    case 2:
    ...
    LocalFolder.prototype.removeZip = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.isZipped()];
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, fs.promises.unlink(this.path + '.zip')];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.isZipped()];
                    case 1:
                        if (_a.sent())
                            return [2 /*return*/, this.path + '.zip'];
                        try {
...
var GitFolder = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _a = this;
                        return [4 /*yield*/, gitRepo.findOne(this.id)];
                    case 2:
                        _a.git = _c.sent();
                        if (!this.git)
                            throw new Error("cannot find git folder with url ".concat(this.getURL()));
                        if (!!fs.existsSync(this.path)) return [3 /*break*/, 5];
                        return [4 /*yield*/, fs.promises.mkdir(this.path)];
                    case 3:
                        _c.sent();
                        return [4 /*yield*/, (0, child_process_async_1.exec)("cd ".concat(this.path, " && git clone ").concat(this.git.address, " ").concat(this.path))];
                    case 4:
                        _c.sent();
                        _c.label = 5;
                    case 5: return [4 /*yield*/, this.removeZip()];
                    case 6:
                        _c.sent();
                        if (!this.git.sha) return [3 /*break*/, 14];
                        _c.label = 7;
                    case 7:
                        _c.trys.push([7, 9, , 13]);
                        return [4 /*yield*/, (0, child_process_async_1.exec)("cd ".concat(this.path, " && git checkout ").concat(this.git.sha))];
                    case 8:
                        _c.sent();
                        return [3 /*break*/, 13];
                    case 9:
                    ...
                    case 14: return [4 /*yield*/, (0, child_process_async_1.exec)("cd ".concat(this.path, " && git pull"))];
                    case 15:
                        _c.sent();
                        _c.label = 16;
                    case 16: return [4 /*yield*/, this._readExecutableManifest()];
                    case 17:
                        _c.sent();
                        return [3 /*break*/, 19];
                    case 18:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_2 = _a.sent();
                        throw new Error(e_2);
                    case 3: return [2 /*return*/, this.executableManifest];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, _super.prototype.getZip.call(this)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fs.promises.readFile(executableFolderPath)];
                    case 1:
