...
var Event = /** @class */ (function () {
     ...
     */
    Event.prototype.setCreatedAt = function () {
     ...
     */
    Event.prototype.setUpdatedAt = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function (type) { return Job_1.Job; }, function (job) { return job.events; })
    ], Event.prototype, "job");
    __decorate([
    ...
    ], Event.prototype, "updatedAt");
    __decorate([
        (0, typeorm_1.DeleteDateColumn)({ type: 'bigint', nullable: true, transformer: {
                to: function (i) { return i ? i.getTime() : null; },
                from: function (i) { return i ? new Date(i) : null; }
            } })
    ], Event.prototype, "deletedAt");
    __decorate([
        (0, typeorm_1.BeforeInsert)()
    ], Event.prototype, "setCreatedAt");
    __decorate([
        (0, typeorm_1.BeforeUpdate)()
    ], Event.prototype, "setUpdatedAt");
    Event = __decorate([
