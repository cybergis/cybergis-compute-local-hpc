...
var Supervisor = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, self.queues[hpcName].isEmpty()];
                    case 3:
                        _c = !(_d.sent());
                        _d.label = 4;
                    case 4:
                        if (!_c) return [3 /*break*/, 11];
                        return [4 /*yield*/, self.queues[hpcName].shift()];
                    case 5:
                        job = _d.sent();
                        if (!job)
                            return [3 /*break*/, 2];
                        maintainer = require("./maintainers/".concat(config_1.maintainerConfigMap[job.maintainer].maintainer))["default"] // typescript compilation hack
                        ;
                        _d.label = 6;
                    case 6:
                        _d.trys.push([6, 7, , 10]);
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, self.db.connect()];
                    case 8:
                        connection = _d.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!!ssh.connection.isConnected()) return [3 /*break*/, 4];
                        return [4 /*yield*/, ssh.connection.connect(ssh.config)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, ssh.connection.execCommand('echo')]; // test connection
                    case 5:
                        _a.sent(); // test connection
                        if (!job.maintainerInstance.isInit) return [3 /*break*/, 7];
                        return [4 /*yield*/, job.maintainerInstance.maintain()];
                    case 6:
                        _a.sent();
                        return [3 /*break*/, 9];
                    case 7: return [4 /*yield*/, job.maintainerInstance.init()];
                    case 8:
                        _a.sent();
                        _a.label = 9;
                    ...
                    case 11:
                        ...
                        if (!job.maintainerInstance.isEnd) return [3 /*break*/, 18];
                        if (!job.maintainerInstance.connector.config.is_community_account) return [3 /*break*/, 14];
                        self.jobCommunitySSHCounters[job.hpc]--;
                        if (!(self.jobCommunitySSHCounters[job.hpc] === 0)) return [3 /*break*/, 13];
                        if (!ssh.connection.isConnected()) return [3 /*break*/, 13];
                        return [4 /*yield*/, ssh.connection.dispose()];
                    case 12:
                        _a.sent();
                        _a.label = 13;
                    case 13: return [3 /*break*/, 17];
                    case 14:
                        if (!ssh.connection.isConnected()) return [3 /*break*/, 16];
                        return [4 /*yield*/, ssh.connection.dispose()];
                    case 15:
                        _a.sent();
                        _a.label = 16;
    ...
    Supervisor.prototype.pushJobToQueue = function (job) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.queues[job.hpc].push(job)];
                    case 1:
                        _a.sent();
