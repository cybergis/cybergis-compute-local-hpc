            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        jobId = job.id;
                        if (!(type === 'JOB_INIT')) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 5];
                    case 3:
                        if (!(type == 'JOB_ENDED' || type === 'JOB_FAILED')) return [3 /*break*/, 5];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, logRepo.save(log)];
                    case 3:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 4:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.createQueryBuilder(Event_1.Event, 'event')
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.createQueryBuilder(Log_1.Log, 'log')
